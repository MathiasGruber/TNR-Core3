 ...
 *
 *  id for this battle type is 01.
 */

require_once(Data::$absSvrPath.'/libs/Battle/BattlePage.php');

class TravelBattle extends BattlePage
{
    ...
    function __construct()
    {
        ...
        $GLOBALS['template']->assign('battle_type','Travel');
    ...
    {
        $this->recordConclusion($username, 'travel', 'won');
    ...
    {
        $this->recordConclusion($username, 'travel', 'loss');
    ...
    {
        $this->recordConclusion($username, 'travel', 'fled');
