 ...
 *
 *  id for this battle type is 02.
 */

require_once(Data::$absSvrPath.'/libs/Battle/BattlePage.php');

class EventBattle extends BattlePage
{
    ...
    function __construct()
    {
        ...
        $GLOBALS['template']->assign('battle_type','Event');
    ...
    {
        $this->recordConclusion($username, 'event', 'won');
    ...
    {
        $this->recordConclusion($username, 'event', 'loss');
    ...
    {
        $this->recordConclusion($username, 'event', 'fled');
