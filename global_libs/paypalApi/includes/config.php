 ...
 */
$api_username = $sandbox ? 'SANDBOX_API_USERNAME' : 'nano.mathias_api1.gmail.com';
$api_password = $sandbox ? 'SANDBOX_API_PASSWORD' : 'P7GLWBZ6NSWJE6KL';
$api_signature = $sandbox ? 'SANDBOX_API_SIGNATURE' : 'AdJznBM19VD-kZ.CC7XyoHUhXGcZAa23Y.OKLXEW0Xil72k-s6fXGYhv';

// Set core 2 account
if( isset($_POST['account']) && $_POST['account'] == "Core2" ){
    $api_username = $sandbox ? 'SANDBOX_API_USERNAME' : 'gruber_api1.mail.tele.dk';
    $api_password = $sandbox ? 'SANDBOX_API_PASSWORD' : 'F7ZC52DD6DXZJUY5';
    $api_signature = $sandbox ? 'SANDBOX_API_SIGNATURE' : 'AkFDFM.-LWZBBbECX.3qGSVmddMEAycl717K8O26KSNeH-t.TqDmupwn';
}
