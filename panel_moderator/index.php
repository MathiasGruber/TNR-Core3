    ...
    class moderator {
        ...
        public function __construct() {
            ...
            try {
                ...
                if (!in_array($GLOBALS['userdata'][0]['user_rank'], array('Admin', 'Supermod', 'Moderator'), true)) {
                ...
                if($GLOBALS['database']->release_lock(__METHOD__,$_SESSION['uid'],__METHOD__) === false) {
                    throw new Exception('There was an issue releasing the lock for your request!');
                }
