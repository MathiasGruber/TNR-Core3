<script type="text/javascript">
    ...
    $.cookie('activeTargetTab', "enemyTarget" ); 
    
    // Set the default action
    if ($.cookie('activeActionTab') && $.cookie('activeActionTab') == "jutsuAction"){
        $.cookie('activeActionTab', "jutsuAction" ); 
    }
    else{
        $.cookie('activeActionTab', "standardAction" ); 
    }
...
<div align="center">
    <table class="table" width="95%" >
           <tr>
            <td class="subHeader">Battle Summary</td>
        </tr>
        <tr>
            <td style="text-align:left;">
                <br>
                <!-- Loop through summary and rewards array -->
                {if isset($summary)}
        ...
        <tr>
            <td align="center"><a href="?id=2">Go to Profile</a><br><br></td>
        </tr>
    </table>
</div>