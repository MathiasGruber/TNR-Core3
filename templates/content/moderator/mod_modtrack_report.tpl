<div align="center">
	...
	<tr>
		<td colspan="4" class="subHeader">Reports Handled By {$mod_data[0]['username']}</td>
	</tr>
	{if $banned != '0 rows'} 
		<tr>
		...
		{for $i = 0 to ($banned|@count)-1} 
			<tr class="row{($i % 2) + 1}">
				...
				<td style="text-align:left;">
				    <a href="?id={$smarty.get.id}&amp;act=reports&amp;page=details&amp;uid={$banned[$i]['uid']}&amp;time={$banned[$i]['time']}&amp;rid={$banned[$i]['rid']}">Details</a>
				</td>
			</tr>
		{/for}
	{else} 
		<tr>
			<td colspan="4" style="border-top:1px solid #000000;">This mod has not handled any reports yet.</td>
		</tr>
	{/if}
	<tr>
