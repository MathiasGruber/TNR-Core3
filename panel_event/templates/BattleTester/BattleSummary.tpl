...
{literal}
	<script>
		$(document).ready(function()
		{
			...
			$('[class^="header_round"]').each(function(index, element)
			{
				if(index == 0)
				{
					$('[class^="'+element.className.split('_')[1]+'"]').show();
					$('[class^="details_'+element.className.split('_')[1]+'"]').show();
				}
			});
...
<table style="border:none;">
	...
	<tr>
		<td>
			<table class="table" align="left" width="512px">
				<tbody>
					<tr><td class="subHeader" colspan="3">Battle Log</td></tr>
