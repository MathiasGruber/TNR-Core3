    ...
    function update_list() {
        ...
        if( $this->mission[0]['value'] == "" ){
            if (tableParser::update_data('site_information', 'option', 'monthlyMission')) {
                ...
                $GLOBALS['database']->execute_query("UPDATE `users` SET `notifications` = "."CONCAT('id:18;duration:none;text:A new monthly mission has been posted.;dismiss:yes;buttons:none;select:none;//',`notifications`)");                
                $GLOBALS['database']->execute_query("UPDATE `users_missions` SET `mission_monthly` = NULL");
                        ...
                        if( $post == "no" || $post > 0 ){
                            ...
                            $GLOBALS['database']->execute_query("
                                ...
                                SET 
                                    ...
                                    `notifications` = '".
                                    "CONCAT('id:18;duration:none;text:".$decision.";dismiss:yes;buttons:none;select:none;//',`notifications`)"."
                                WHERE 
